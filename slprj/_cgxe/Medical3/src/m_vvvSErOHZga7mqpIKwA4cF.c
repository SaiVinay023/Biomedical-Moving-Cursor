...
static void cgxe_mdl_start(InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
...
static void mw__internal__call__reset(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_vvvSErOHZga7mqpIKwA4cF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_vvvSErOHZga7mqpIKwA4cF(SimStruct *S, int_T tid)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_vvvSErOHZga7mqpIKwA4cF(SimStruct *S, int_T tid)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_vvvSErOHZga7mqpIKwA4cF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
  InstanceStruct_vvvSErOHZga7mqpIKwA4cF *moduleInstance =
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF *)calloc(1, sizeof
    (InstanceStruct_vvvSErOHZga7mqpIKwA4cF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_vvvSErOHZga7mqpIKwA4cF);
  ssSetmdlInitializeConditions(S, mdlInitialize_vvvSErOHZga7mqpIKwA4cF);
  ssSetmdlUpdate(S, mdlUpdate_vvvSErOHZga7mqpIKwA4cF);
  ssSetmdlTerminate(S, mdlTerminate_vvvSErOHZga7mqpIKwA4cF);
  ssSetmdlEnable(S, mdlEnable_vvvSErOHZga7mqpIKwA4cF);
  ssSetmdlDisable(S, mdlDisable_vvvSErOHZga7mqpIKwA4cF);
...
static void mdlProcessParameters_vvvSErOHZga7mqpIKwA4cF(SimStruct *S)
{
}

void method_dispatcher_vvvSErOHZga7mqpIKwA4cF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_vvvSErOHZga7mqpIKwA4cF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_vvvSErOHZga7mqpIKwA4cF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_vvvSErOHZga7mqpIKwA4cF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_vvvSErOHZga7mqpIKwA4cF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: vvvSErOHZga7mqpIKwA4cF.\n"
...
mxArray *cgxe_vvvSErOHZga7mqpIKwA4cF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_vvvSErOHZga7mqpIKwA4cF_fallback_info(void)
{
